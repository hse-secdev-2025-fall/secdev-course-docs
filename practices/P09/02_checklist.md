...
## Файл: `practices/P09/02_checklist.md`
...
## Итоговая практика P09 считается сданной, если:

- суммарно набрано **≥ 5 баллов**,
- нет нулей по **C1–C3**,
- workflow `ci-sbom-sca.yml` даёт зелёный job на актуальном состоянии ветки `p09-sbom-sca`.
